        ...
        <div class="main-container flex col center">
            ...
            <div class="img-triple flex row center">
                ...
                <div class="img-text flex col">
                    ...
                    <p>We are so proud of our efforts not only for our relationship but for our discipleship. She served on her callings so well and I did my best as a missionary.</p>
                </div>
                <div class="img-text flex col">
            ...
            <div class="img-triple flex row center">
                <div class="img-text flex col">
                    <img src="../img/marriage6.jpg" alt="">
                    <p>Same place of our first time in a Temple together. Few years after being there for a friend, we were there to seal our relationship.</p>
                </div>
                <div class="img-text flex col">
            ...
            <div class="flex row center">
                <button><a href="mission.php">Previous</a></button>
                <button><a href="lucas.php">Next</a></button>
            </div>
